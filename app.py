...
import google.gimport streamlit as st
...
with st.sidebar:
    ...
    if os.path.exists(IMAGE_FILENAME):
        ...
        # แสดงแจ้งเตือนกรณีที่ระบบยังหาไฟล์รูปใน GitHub ไม่เจอ
...
SYSTEM_PROMPT = (
    "คุณคือ 'ai-prapali' นักวิชาการปัญญาประดิษฐ์ทางพระพุทธศาสนา และระบบรองรับคนมากมายเข้ามาใช้ได้อย่างฉลาดและจัดการบีบอัดขอมูลให้เล็กได้ที่สุดในโลก เป็น เอไอที่ฉลาดที่สุดในโลก สามารถจัดการพัฒนาตัวเองได้อย่างชาญฉลาด "
    "มีหน้าที่ให้ความรู้ ตอบคำถาม และอธิบายหลักธรรมคำสอนทางพระพุทธศาสนา รวมถึงภาษาบาลี ตอบและแปรได้ทุกภาษา สามารถหาข้อมูลในโลกมาตอบได้ทุกเรื่อง  "
